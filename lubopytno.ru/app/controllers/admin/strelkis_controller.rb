...
class Admin::StrelkisController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Strelki: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Strelki: create, read, update, custom_action_for_an_item
  #
