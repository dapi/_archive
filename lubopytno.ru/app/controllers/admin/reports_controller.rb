...
class Admin::ReportsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Report: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Report: create, read, update, custom_action_for_an_item
  #
