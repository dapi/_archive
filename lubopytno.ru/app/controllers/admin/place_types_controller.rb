...
class Admin::PlaceTypesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     PlaceType: create, read, update, destroy, custom_action
  #
  #   editor:
  #     PlaceType: create, read, update, custom_action_for_an_item
  #
