...
class Admin::ResultsToCompanyGroupsController < Admin::MasterController
  
  def update_companies
    r=ResultsToCompanyGroup.find(params[:id])
    r.update_companies
    redirect_to :back
    #_back_or_default('/admin/results_to_company_groups')
  end
...
=begin
  ...
  #
  #   admin:
  #     ResultsToCompanyGroup: create, read, update, destroy, custom_action
  #
  #   editor:
  #     ResultsToCompanyGroup: create, read, update, custom_action_for_an_item
  #
