...
class Admin::AdResultsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Result: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Result: create, read, update, custom_action_for_an_item
  #
