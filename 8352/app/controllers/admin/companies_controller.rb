...
class Admin::CompaniesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Company: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Company: create, read, update, custom_action_for_an_item
  #
