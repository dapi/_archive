...
class Admin::AddressesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Address: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Address: create, read, update, custom_action_for_an_item
  #
