...
class Admin::TelefonRenamesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     TelefonRename: create, read, update, destroy, custom_action
  #
  #   editor:
  #     TelefonRename: create, read, update, custom_action_for_an_item
  #
