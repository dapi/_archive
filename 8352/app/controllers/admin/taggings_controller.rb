...
class Admin::TaggingsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Tagging: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Tagging: create, read, update, custom_action_for_an_item
  #
