...
class Admin::AdCategoriesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Category: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Category: create, read, update, custom_action_for_an_item
  #
