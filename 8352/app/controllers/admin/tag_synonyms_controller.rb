...
class Admin::TagSynonymsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     TagSynonym: create, read, update, destroy, custom_action
  #
  #   editor:
  #     TagSynonym: create, read, update, custom_action_for_an_item
  #
