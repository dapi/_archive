...
class Admin::TagsSynonymsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     TagsSynonym: create, read, update, destroy, custom_action
  #
  #   editor:
  #     TagsSynonym: create, read, update, custom_action_for_an_item
  #
