...
class Admin::FollowsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Follow: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Follow: create, read, update, custom_action_for_an_item
  #
